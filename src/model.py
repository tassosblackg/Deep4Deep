...
class CNN(object):
    ...
    def define_train_operations(self):
        ...
        Y_data_train = tf.placeholder( tf.int32,shape=(None,n_classes) ) # Define this
        ...
        optimizer = tf.train.AdamOptimizer(learning_rate) # Define it --shall we try different type of optimizers
        ...
        X_data_valid = tf.placeholder( tf.float32,shape=(None,height,width,chan) ) # Define this
        Y_data_valid = tf.placeholder( tf.int32,shape=(None,n_classes) ) # Define this
